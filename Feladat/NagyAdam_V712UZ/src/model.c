...
void init_entities(World* world) {
	...
	load_model("models//szekreny.obj", &world->szekreny.model);
	world->szekreny.texture = load_texture("textures//szekreny.jpg");
	init_object(&world->szekreny, -150,-180);
	
	load_model("models//desk.obj", &world->desk.model);
	world->desk.texture = load_texture("textures//szekreny.jpg");
	init_object(&world->desk, 0,-120);
	
	load_model("models//bosschair.obj", &world->bosschair.model);
	world->bosschair.texture = load_texture("textures//bosschair.jpg");
	init_object(&world->bosschair, 0,-150);
	
	load_model("models//door.obj", &world->door.model);
	world->door.texture = load_texture("textures//door.jpg");
	init_object(&world->door, 0,220.5);
	
	load_model("models//szekreny_2.obj", &world->szekreny_2.model);
	world->szekreny_2.texture = load_texture("textures//szekreny.jpg");
	init_object(&world->szekreny_2, 170,-60);
	
	load_model("models//logo.obj", &world->logo.model);
	world->logo.texture = load_texture("textures//bosschair.jpg");
	init_object(&world->logo, 0,-200);
	
	load_model("models//sarokulo.obj", &world->sarokulo.model);
	world->sarokulo.texture = load_texture("textures//sofa.jpg");
	init_object(&world->sarokulo, -130,150);
	
	load_model("models//chair.obj", &world->chair.model);
	world->chair.texture = load_texture("textures//chair.jpg");
	init_object(&world->chair, 25,-80);
	
	load_model("models//chair.obj", &world->chair2.model);
	world->chair2.texture = load_texture("textures//chair.jpg");
	init_object(&world->chair2, -25,-80);
	...
	world->room.top = load_texture("textures//plafon.jpg");
